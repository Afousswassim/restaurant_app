...
class _ClientLoginScreenState extends State<ClientLoginScreen> {
  ...
  Future<void> _submit() async {
    ...
    final success = await clientProvider.login(email: email, password: password);
    ...
    if (mounted) {
      if (success) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(clientProvider.error ?? 'Authentication failed'),
              ...
              children: [
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Sign in to order your gourmet meals',
                ...
                Row(
                  ...
                  children: [
                    ...
                    TextButton(
                      onPressed: () {
                        Navigator.of(context).pushReplacementNamed(ClientRegisterScreen.routeName);
                      },
                      child: const Text(
                        'Register Now',
                        style: TextStyle(
